...
import com.adityamshidlyali.vtunotify.databinding.FragmentWorkshopBinding
...
class WorkshopsFragment : Fragment(), NotificationItemAdapter.OnItemClickListener {
    private lateinit var viewModel: NotificationViewModel

    private var _binding: FragmentWorkshopBinding? = null

    private val binding: FragmentWorkshopBinding
        get() = _binding!!
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.notificationRecyclerView.textViewNotificationTitle.text =
            "Workshops/Seminar/Conference/FDP"
        ...
        viewModel.getNotifications("https://vtu.ac.in/category/workshop-seminar-conference-fdp/")
