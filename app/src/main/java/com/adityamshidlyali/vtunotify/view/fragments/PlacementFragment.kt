...
import com.adityamshidlyali.vtunotify.databinding.FragmentPlacementBinding
...
class PlacementFragment : Fragment(R.layout.fragment_placement),
    ...
    private val binding: FragmentPlacementBinding
        get() = _binding!!
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getNotifications("https://vtu.ac.in/en/placement/")
